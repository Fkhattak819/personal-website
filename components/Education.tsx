...
export default function Education() {
  return (
    <section id="education" className="mb-12">
      <h2 className="text-2xl md:text-3xl font-bold mb-8 text-white text-left">Background Education</h2>
      <div className="relative mt-12">
        {/* Timeline line */}
        <div className="absolute left-1/2 -top-10 -bottom-10 w-0.5 bg-gray-200 -translate-x-1/2 hidden md:block"></div>
          ...
          {education.map((item, index) => (
            <div key={index} className="flex flex-col md:flex-row items-center justify-between gap-8 relative">
              ...
              <div className="relative z-10 order-1 md:order-2">
                <div className="w-12 h-12 rounded-full bg-[#1C1C1C] border border-gray-700 flex items-center justify-center">
              ...
              <div className="flex-1 text-center md:text-left order-3 w-full md:w-auto">
                ...
                <div className="w-12 h-0.5 bg-gray-300 mb-4 mx-auto md:mx-0"></div>
